...
int main(void) {
    ...
    try {
        ...
        form1 = new PresidentialPardonForm("Zaphod'a Teslim Edilecek Kisi"); 
        form2 = new RobotomyRequestForm("Kedi Mimar");
        form3 = new ShrubberyCreationForm("Tatil Evi");
        ...
        PresidentialPardonForm form_p_test("Lowbie_Test_Hedefi");
